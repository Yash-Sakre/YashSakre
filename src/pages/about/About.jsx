    ...
    <div className="xl:min-h-screen flex flex-col " id="about">
      ...
      <div className=" md:flex py-4 items-center gap-60">
        <div className="md:w-[50%]">
          Currently, in my final year of studies pursuing a Bachelor&apos; s degree in
          Computer Science, I have developed a strong foundation in frontend
          technologies such as HTML, CSS, and JavaScript. I have also gained
          experience with modern frameworks including React and Tailwind CSS,
        ...
        <div className=""><img className="mx-auto" src={download} alt=""/></div>
      </div>
